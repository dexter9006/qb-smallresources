...
Config.PauseMapText = '~g~Pain~s~ | ~y~Island ~w~RP''                                     -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
...
Config.Objects = { -- for object removal
    { coords = vector3(266.09, -349.35, 44.74), heading = 0, length = 200, width = 200, model = 'prop_sec_barier_02b' }, -- parking Occupation Avenue
    { coords = vector3(285.28, -355.78, 45.13), heading = 0, length = 200, width = 200, model = 'prop_sec_barier_02a' }, -- parking Occupation Avenue
